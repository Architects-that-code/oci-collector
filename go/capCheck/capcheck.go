...
func Check(provider common.ConfigurationProvider, regions []identity.RegionSubscription, tenancyID string, compartment []identity.Compartment, capacityFetch bool, capacityShapeOCPUs int, capacityShapeMemory int) {
	...
	for _, region := range regions {
		...
		for _, ad := range ads {
			...
			sadetails[0] = core.CreateCapacityReportShapeAvailabilityDetails{
				InstanceShape: common.String("VM.Standard.E4.Flex"),
